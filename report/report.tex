...
%We need a better name for this section - I changed research to analysis, is that good?
\section{Analysis}
...
We now move onto the extremeties in the second quadrant. The second quadrant obiouvsly contains the districts that obtained high convex hull scores but low Polsby-Popper ones. This is what would constitute a false negative categorization of districts for Polsby-Popper. The focus will be on OH-10, OR-02, OR-04, OR-01, and UT-03 as these two districts had the highest convex hull score. %it said fatness, I assume this was not intended?
